========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex11b
========================================================================


Diese ex11b-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex11b.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex11b.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in ex11b.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

ex11bDoc.h, ex11bDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx11bDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx11bDoc::Serialize).

ex11bView.h, ex11bView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx11bView.
    	CEx11bView-Objekte werden verwendet, um CEx11bDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex11b.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
