========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex11c
========================================================================


Diese ex11c-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex11c.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex11c.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in ex11c.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

ex11cDoc.h, ex11cDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx11cDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx11cDoc::Serialize).

ex11cView.h, ex11cView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx11cView.
    	CEx11cView-Objekte werden verwendet, um CEx11cDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex11c.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
