========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex07b
========================================================================


Diese ex07b-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex07b.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex07b.rc eingebunden.
...
ex07bDoc.h, ex07bDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx07bDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx07bDoc::Serialize).

ex07bView.h, ex07bView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx07bView.
    	CEx07bView-Objekte werden verwendet, um CEx07bDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex07b.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
