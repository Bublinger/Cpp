========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex06a
========================================================================


Diese ex06a-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex06a.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex06a.rc eingebunden.
...
ex06aDoc.h, ex06aDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx06aDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx06aDoc::Serialize).

ex06aView.h, ex06aView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx06aView.
    	CEx06aView-Objekte werden verwendet, um CEx06aDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex06a.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
