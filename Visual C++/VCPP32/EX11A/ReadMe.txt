========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex11a
========================================================================


Diese ex11a-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex11a.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex11a.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in ex11a.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

ex11aDoc.h, ex11aDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx11aDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx11aDoc::Serialize).

ex11aView.h, ex11aView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx11aView.
    	CEx11aView-Objekte werden verwendet, um CEx11aDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex11a.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
