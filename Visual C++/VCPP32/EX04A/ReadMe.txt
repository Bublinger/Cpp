========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex04a
========================================================================


Diese ex04a-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex04a.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex04a.rc eingebunden.
...
ex04aDoc.h, ex04aDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx04aDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx04aDoc::Serialize).

ex04aView.h, ex04aView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx04aView.
    	CEx04aView-Objekte werden verwendet, um CEx04aDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex04a.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
