========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Ex09a
========================================================================


Diese Ex09a-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Ex09a.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Ex09a.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in Ex09a.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

Ex09aDoc.h, Ex09aDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx09aDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx09aDoc::Serialize).

Ex09aView.h, Ex09aView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx09aView.
    	CEx09aView-Objekte werden verwendet, um CEx09aDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Ex09a.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
