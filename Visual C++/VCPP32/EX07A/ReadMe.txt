========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex07a
========================================================================


Diese ex07a-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex07a.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex07a.rc eingebunden.
...
ex07aDoc.h, ex07aDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx07aDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx07aDoc::Serialize).

ex07aView.h, ex07aView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx07aView.
    	CEx07aView-Objekte werden verwendet, um CEx07aDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex07a.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
