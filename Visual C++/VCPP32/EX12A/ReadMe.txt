========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex12a
========================================================================


Diese ex12a-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex12a.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex12a.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in ex12a.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

ex12aDoc.h, ex12aDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx12aDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx12aDoc::Serialize).

ex12aView.h, ex12aView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx12aView.
    	CEx12aView-Objekte werden verwendet, um CEx12aDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex12a.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
