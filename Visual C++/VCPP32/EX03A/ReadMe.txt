========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex03a
========================================================================


Diese ex03a-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex03a.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex03a.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in ex03a.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

ex03aDoc.h, ex03aDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx03aDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx03aDoc::Serialize).

ex03aView.h, ex03aView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx03aView.
    	CEx03aView-Objekte werden verwendet, um CEx03aDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex03a.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
