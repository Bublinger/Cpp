========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex04b
========================================================================


Diese ex04b-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex04b.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex04b.rc eingebunden.
...
ex04bDoc.h, ex04bDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CEx04bDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CEx04bDoc::Serialize).

ex04bView.h, ex04bView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CEx04bView.
    	CEx04bView-Objekte werden verwendet, um CEx04bDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex04b.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
