// Ex06bDialog.cpp : Implementierungsdatei
//
...
void CEx06bDialog::DoDataExchange(CDataExchange* pDX)
{
	...
	if (pDX->m_bSaveAndValidate) {
		TRACE("Datenelemente des Schiebereglers werden aktualisiert\n");
		CSliderCtrl* pSlide1 =
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen für Nachrichten CEx06bDialog
...
BOOL CEx06bDialog::OnInitDialog() 
{
	...
	HICON hIcon[8];
	int n;
	m_imageList.Create(16, 16, 0, 8, 8); // 32, 32 für große Symbole
	...
	static char* color[] = {"weiß", "schwarz", "rot",
	                        "blau", "gelb", "türkis",
	                        "lila", "grün"};
	CListCtrl* pList =
...
void CEx06bDialog::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
	...
	// Zwei Schieberegler senden
	//  HSCROLL-Nachrichten (unterschiedliche Verarbeitung)
...
void CEx06bDialog::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
	if (nSBCode == SB_ENDSCROLL) {
		return; // Seltsame Meldungen zurückweisen
	}
	// Nur von IDC_SPIN1 Nachrichten über Bildlauf verarbeiten
