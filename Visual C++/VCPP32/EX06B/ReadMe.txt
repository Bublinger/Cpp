========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : ex06b
========================================================================


Diese ex06b-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\ex06b.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei ex06b.rc eingebunden.
...
ex06bDoc.h, ex06bDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse Cex06bDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von Cex06bDoc::Serialize).

ex06bView.h, ex06bView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse Cex06bView.
    	Cex06bView-Objekte werden verwendet, um Cex06bDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	ex06b.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
